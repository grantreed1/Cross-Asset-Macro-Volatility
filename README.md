...
* **Drawdown Mitigation:** Unlike passive short-volatility ETFs (e.g., SVXY) which suffer catastrophic tail risk, the integrated long-leg protection constrained the maximum drawdown during market shocks.

## Capacity & Execution Constraints
The strategy operates within strict liquidity parameters:
* **Target AUM:** $10M – $100M
